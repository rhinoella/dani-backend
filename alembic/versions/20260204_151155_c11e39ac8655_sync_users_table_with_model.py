...
def upgrade() -> None:
    ...
    sa.Column('style', sa.Enum('modern', 'corporate', 'minimal', 'vibrant', 'dark', name='infographic_style'), nullable=False, comment='Visual style of the infographic'),
    ...
    sa.Column('status', sa.Enum('pending', 'generating', 'completed', 'failed', name='infographic_status'), nullable=False, comment='Generation status'),
